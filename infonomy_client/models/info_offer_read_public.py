...
class InfoOfferReadPublic(BaseModel):
    """
    InfoOfferReadPublic
    """ # noqa: E501
    id: StrictInt
    ...
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "human_seller_id", "bot_seller_id", "seller_type", "context_id", "public_info", "price", "created_at"]
