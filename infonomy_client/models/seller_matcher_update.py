...
class SellerMatcherUpdate(BaseModel):
    """
    SellerMatcherUpdate
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if min_max_budget (nullable) is None
        # and model_fields_set contains the field
        if self.min_max_budget is None and "min_max_budget" in self.model_fields_set:
            _dict['min_max_budget'] = None

        # set to None if min_inspection_rate (nullable) is None
        # and model_fields_set contains the field
        if self.min_inspection_rate is None and "min_inspection_rate" in self.model_fields_set:
            _dict['min_inspection_rate'] = None

        # set to None if min_purchase_rate (nullable) is None
        # and model_fields_set contains the field
        if self.min_purchase_rate is None and "min_purchase_rate" in self.model_fields_set:
            _dict['min_purchase_rate'] = None

        # set to None if min_priority (nullable) is None
        # and model_fields_set contains the field
        if self.min_priority is None and "min_priority" in self.model_fields_set:
            _dict['min_priority'] = None
