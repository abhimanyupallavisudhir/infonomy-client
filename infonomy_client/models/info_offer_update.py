...
class InfoOfferUpdate(BaseModel):
    """
    InfoOfferUpdate
    """ # noqa: E501
    private_info: Optional[StrictStr] = None
    public_info: Optional[StrictStr] = None
    price: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["private_info", "public_info", "price"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if private_info (nullable) is None
        # and model_fields_set contains the field
        if self.private_info is None and "private_info" in self.model_fields_set:
            _dict['private_info'] = None
